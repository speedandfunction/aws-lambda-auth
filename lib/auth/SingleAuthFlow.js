...
const {createAllowPolicy} = require('../policy');
const logger = require('../logger');

module.exports = class SingleAuthFlow {
  ...
  _getHandler() {
    if (!this._handler) {
      throw new Error('Handler was not defined through "useHandler" method');
    }
